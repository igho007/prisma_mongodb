...
exports.postRouter.post("/create-comment/:id", [(0, express_validator_1.check)("text", "Enter text").not().isEmpty()], likesAndComment_1.createComment);
...
exports.postRouter.delete("/post/:post_id/:comment_id", likesAndComment_1.DeleteCommentById);
